...
import { htmlBeautify } from './gulp/tasks/html-beautify.js';
...
const backend = gulp.series(clean, htmlInclude, scriptsBackend, stylesBackend, resources, images, webpImages, svgSprites, htmlBeautify);
const build = gulp.series(clean, htmlInclude, scripts, styles, resources, images, webpImages, svgSprites, htmlMinify, htmlBeautify);
